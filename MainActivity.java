package com.socialtools.camerono3480.haterblocker;
...
public class MainActivity extends AppCompatActivity implements AsyncResponse, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etbutton = (EditText) findViewById(R.id.etbutton);
        button = (Button) findViewById(R.id.button);
        button.setOnClickListener(this);

        donatebtn = (WebView) findViewById(R.id.donatebtn);
        donatebtn.loadUrl("file:///android_asset/donate.html");
    ...
    public void onClick(View v) {
        ...
        postData.put("txtUsername", etbutton.getText().toString());

        PostResponseAsyncTask task = new PostResponseAsyncTask(this, postData);
        task.execute("http://haterblocker.comuf.com/filters.php");
    }
}
